...
=head1 The Pod::SpeakIt::MacSpeech module

This is the I<README> for the L<Pod::SpeakIt::MacSpeech> Perl module. You're probably 
...
To read about L<Pod::SpeakIt::MacSpeech>, look at the embedded documentation 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Pod-SpeakIt-MacSpeech> or 
L<MetaCPAN|http://www.metacpan.org/module/Pod::SpeakIt::MacSpeech>:

=over 4

=item *	L<http://search.cpan.org/dist/Pod-SpeakIt-MacSpeech>

=item *	L<http://www.metacpan.org/module/Pod::SpeakIt::MacSpeech>
...
=item *	L<https://github.com/briandfoy/Pod-Speakit-MacSpeech>

=back

If you find a problem, file a ticket in the L<issue 
tracker|https://github.com/briandfoy/Pod-Speakit-MacSpeech/issues>:

=over 4

=item *	L<https://github.com/briandfoy/Pod-Speakit-MacSpeech/issues>
